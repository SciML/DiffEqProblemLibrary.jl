...
NonlinearProblemLibrary.jl is a component of the [DiffEqProblemLibrary.jl](https://github.com/SciML/DiffEqProblemLibrary.jl) monorepo. A library of premade nonlinear systems (NonlinearProblems) for testing and benchmarking nonlinear solvers.
