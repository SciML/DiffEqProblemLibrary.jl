...
\begin{align*}
\frac{dy_1}{dt} &= y_2 \\
\frac{dy_2}{dt} &= - \frac{1}{\lambda} t y_2
\end{align*}
```
...
\begin{align*}
\frac{dy_1}{dt} &= y_2 \\
\frac{dy_2}{dt} &= \frac{1}{\lambda} t y_1
\end{align*}
```
...
```math
\begin{align*}
y_1(t) &= \sin(\pi t/2\lambda) \text{ when } 1/\lambda \text{ is odd } \\
y_2(t) &= y_1'(t)
\end{align*}
```
