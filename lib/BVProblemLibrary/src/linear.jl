...
function prob_bvp_linear_1_bca!(resid_a, u_a, p)
    return resid_a[1] = u_a[1] - 1
end
function prob_bvp_linear_1_bcb!(resid_b, u_b, p)
    return resid_b[1] = u_b[1]
end
...
"""
prob_bvp_linear_1 = BVProblem(
    prob_bvp_linear_1_function,
    [1.0, 0.0],
...
"""
prob_bvp_linear_2 = BVProblem(
    prob_bvp_linear_2_function,
    [1.0, 0.0],
...
function prob_bvp_linear_3_f(t, u1, u2)
    return -(2 + cos(π * t)) * u2 + u1 - (1 + λ * π^2) * cos(π * t) -
        (2 + cos(π * t)) * π * sin(π * t)
end
function prob_bvp_linear_3_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_3_f(t, u[1], u[2])
end
function prob_bvp_linear_3_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1] + 1
end
function prob_bvp_linear_3_bcb!(res_b, u_b, p)
    return res_b[1] = u_b[1] + 1
end
...
"""
prob_bvp_linear_3 = BVProblem(
    prob_bvp_linear_3_function,
    [1.0, 0.0],
...
function prob_bvp_linear_4_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_4_f(u[1], u[2], p)
end
function prob_bvp_linear_4_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1] - 1 - exp(-2)
end
function prob_bvp_linear_4_bcb!(res_b, u_b, p)
    return res_b[1] = u_b[1] - 1 - exp(-2 * (1 + p) / p)
end
...
"""
prob_bvp_linear_4 = BVProblem(
    prob_bvp_linear_4_function,
    [1.0, 0.0],
...
function prob_bvp_linear_5_f(t, u1, u2, λ)
    return t * u2 + u1 - (1 + λ * π^2) * cos(π * t) + π * t * sin(π * t)
end
function prob_bvp_linear_5_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_5_f(t, u[1], u[2], p)
end
...
"""
prob_bvp_linear_5 = BVProblem(
    prob_bvp_linear_5_function,
    [1.0, 0.0],
...
function prob_bvp_linear_6_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_6_f(t, u[2], p)
end
function prob_bvp_linear_6_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1] + 2
end
function prob_bvp_linear_6_bcb!(res_b, u_b, p)
    return res_b[1] = u_b[1]
end
...
"""
prob_bvp_linear_6 = BVProblem(
    prob_bvp_linear_6_function,
    [1.0, 0.0],
...
function prob_bvp_linear_7_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_7_f(t, u[1], u[2], p)
end
...
"""
prob_bvp_linear_7 = BVProblem(
    prob_bvp_linear_7_function,
    [1.0, 0.0],
...
"""
prob_bvp_linear_8 = BVProblem(
    prob_bvp_linear_8_function,
    [1.0, 0.0],
...
function prob_bvp_linear_9_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / (p + t^2) * prob_bvp_linear_9_f(t, u[1], u[2], p)
end
function prob_bvp_linear_9_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1] - 1 / (1 + p)
end
function prob_bvp_linear_9_bcb!(res_b, u_b, p)
    return res_b[1] = u_b[1] - 1 / (1 + p)
end
...
"""
prob_bvp_linear_9 = BVProblem(
    prob_bvp_linear_9_function,
    [1.0, 0.0],
...
function prob_bvp_linear_10_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_10_f(t, u[2], p)
end
function prob_bvp_linear_10_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1]
end
...
"""
prob_bvp_linear_10 = BVProblem(
    prob_bvp_linear_10_function,
    [1.0, 0.0],
...
function prob_bvp_linear_11_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_11_f(t, u[1], p)
end
...
"""
prob_bvp_linear_11 = BVProblem(
    prob_bvp_linear_11_function,
    [1.0, 0.0],
...
function prob_bvp_linear_12_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_12_f(t, u[1], p)
end
...
"""
prob_bvp_linear_12 = BVProblem(
    prob_bvp_linear_12_function,
    [1.0, 0.0],
...
"""
prob_bvp_linear_13 = BVProblem(
    prob_bvp_linear_13_function,
    [1.0, 0.0],
...
function prob_bvp_linear_14_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_14_f(t, u[1], p)
end
function prob_bvp_linear_14_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1] - exp(-2 / sqrt(p))
end
function prob_bvp_linear_14_bcb!(res_b, u_b, p)
    return res_b[1] = u_b[1] - exp(-2 / sqrt(p))
end
...
"""
prob_bvp_linear_14 = BVProblem(
    prob_bvp_linear_14_function,
    [1.0, 0.0],
...
function prob_bvp_linear_15_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = 1 / p * prob_bvp_linear_15_f(t, u[1], p)
end
...
"""
prob_bvp_linear_15 = BVProblem(
    prob_bvp_linear_15_function,
    [1.0, 0.0],
...
"""
prob_bvp_linear_16 = BVProblem(
    prob_bvp_linear_16_function,
    [1.0, 0.0],
...
function prob_bvp_linear_17_f!(du, u, p, t)
    du[1] = u[2]
    return du[2] = -3 * p * u[1] / (p + t^2)^2
end
function prob_bvp_linear_17_bca!(res_a, u_a, p)
    return res_a[1] = u_a[1] + 0.1 / sqrt(p + 0.01)
end
function prob_bvp_linear_17_bcb!(res_b, u_b, p)
    return res_b[1] = u_b[1] - 0.1 / sqrt(p + 0.01)
end
...
"""
prob_bvp_linear_17 = BVProblem(
    prob_bvp_linear_17_function,
    [1.0, 0.0],
...
"""
prob_bvp_linear_18 = BVProblem(
    prob_bvp_linear_18_function,
    [1.0, 0.0],
