...
prob_bvp_linear_1_function = ODEFunction(prob_bvp_linear_1_f!, analytic=prob_bvp_linear_1_analytic)
prob_bvp_linear_1_tspan = (0., 1.)
@doc raw"""
    prob_bvp_linear_1
...
"""
prob_bvp_linear_1 = BVProblem(prob_bvp_linear_1_function, prob_bvp_linear_1_bc!, [1., 0.], prob_bvp_linear_1_tspan, λ)
...
prob_bvp_linear_2_function = ODEFunction(prob_bvp_linear_2_f!, analytic=prob_bvp_linear_2_analytic)
prob_bvp_linear_2_tspan = (0., 1.)
@doc raw"""
    prob_bvp_linear_2
...
"""
prob_bvp_linear_2 = BVProblem(prob_bvp_linear_2_function, prob_bvp_linear_2_bc!, [1., 0.], prob_bvp_linear_2_tspan, λ)
...
prob_bvp_linear_3_f(t, u1, u2) = -(2+cos(π*t))*u2 + u1 - (1+λ*π^2)*cos(π*t) - (2+cos(π*t))*π*sin(π*t)
...
prob_bvp_linear_3_function = ODEFunction(prob_bvp_linear_3_f!, analytic=prob_bvp_linear_3_analytic)
prob_bvp_linear_3_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_3
...
"""
prob_bvp_linear_3 = BVProblem(prob_bvp_linear_3_function, prob_bvp_linear_3_bc!, [1., 0.], prob_bvp_linear_3_tspan, λ)
...
prob_bvp_linear_4_function = ODEFunction(prob_bvp_linear_4_f!, analytic=prob_bvp_linear_4_analytic)
prob_bvp_linear_4_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_4
...
"""
prob_bvp_linear_4 = BVProblem(prob_bvp_linear_4_function, prob_bvp_linear_4_bc!, [1., 0.], prob_bvp_linear_4_tspan, λ)
...
prob_bvp_linear_5_f(t, u1, u2, λ) = t*u2+u1-(1+λ*π^2)*cos(π*t)+π*t*sin(π*t)
...
prob_bvp_linear_5_function = ODEFunction(prob_bvp_linear_5_f!, analytic=prob_bvp_linear_5_analytic)
prob_bvp_linear_5_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_5
...
"""
prob_bvp_linear_5 = BVProblem(prob_bvp_linear_5_function, prob_bvp_linear_5_bc!, [1., 0.], prob_bvp_linear_5_tspan, λ)
...
function prob_bvp_linear_6_analytic(u, λ, t)
    ...
    -π*sin(π*t) + 1/sqrt(2*λ)*2/sqrt(π)*exp(-t^2/(2*λ))/erf(1/sqrt(2*λ))]
end
...
prob_bvp_linear_6_function = ODEFunction(prob_bvp_linear_6_f!, analytic=prob_bvp_linear_6_analytic)
prob_bvp_linear_6_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_6
...
"""
prob_bvp_linear_6 = BVProblem(prob_bvp_linear_6_function, prob_bvp_linear_6_bc!, [1., 0.], prob_bvp_linear_6_tspan, λ)
...
function prob_bvp_linear_7_analytic(u, λ, t)
    [cos(π*t) + t + (t*erf(t/sqrt(2*λ)) + sqrt(2*λ/π)*exp(-t^2/(2*λ)))/(erf(1/sqrt(2*λ)) + sqrt(2*λ/π)*exp(-1/(2*λ))),
    -π*sin(π*t) + 1 + (erf(t/sqrt(2*λ)) + 2*t/sqrt(π)*exp(-t^2/(2*λ))/sqrt(2*λ) - t/λ*sqrt(2*λ/π)*exp(-t^2/(2*λ)))/(erf(1/sqrt(2*λ)) + sqrt(2*λ/π)*exp(-1/(2*λ)))]
end
prob_bvp_linear_7_f(t, u1, u2, λ) = -t*u2 + u1 - (1+λ*π^2)*cos(π*t)-π*t*sin(π*t)
...
prob_bvp_linear_7_function = ODEFunction(prob_bvp_linear_7_f!, analytic=prob_bvp_linear_7_analytic)
prob_bvp_linear_7_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_7
...
"""
prob_bvp_linear_7 = BVProblem(prob_bvp_linear_7_function, prob_bvp_linear_7_bc!, [1., 0.], prob_bvp_linear_7_tspan, λ)
...
prob_bvp_linear_8_function = ODEFunction(prob_bvp_linear_8_f!, analytic=prob_bvp_linear_8_analytic)
prob_bvp_linear_8_tspan = (0., 1.)
@doc raw"""
    prob_bvp_linear_8
...
"""
prob_bvp_linear_8 = BVProblem(prob_bvp_linear_8_function, prob_bvp_linear_8_bc!, [1., 0.], prob_bvp_linear_8_tspan, λ)
...
prob_bvp_linear_9_function = ODEFunction(prob_bvp_linear_9_f!, analytic=prob_bvp_linear_9_analytic)
prob_bvp_linear_9_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_9
...
"""
prob_bvp_linear_9 = BVProblem(prob_bvp_linear_9_function, prob_bvp_linear_9_bc!, [1., 0.], prob_bvp_linear_9_tspan, λ)
...
prob_bvp_linear_10_function = ODEFunction(prob_bvp_linear_10_f!, analytic=prob_bvp_linear_10_analytic)
prob_bvp_linear_10_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_10
...
"""
prob_bvp_linear_10 = BVProblem(prob_bvp_linear_10_function, prob_bvp_linear_10_bc!, [1., 0.], prob_bvp_linear_10_tspan, λ)
...
prob_bvp_linear_11_function = ODEFunction(prob_bvp_linear_11_f!, analytic=prob_bvp_linear_11_analytic)
prob_bvp_linear_11_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_11
...
"""
prob_bvp_linear_11 = BVProblem(prob_bvp_linear_11_function, prob_bvp_linear_11_bc!, [1., 0.], prob_bvp_linear_11_tspan, λ)
...
function prob_bvp_linear_12_analytic(u, λ, t)
    ...
    -π*sin(π*t)+(a*exp((t+1)*a)+a*exp((-t-1)*a))/(exp(2*a)-exp(-2*a))]
end
...
prob_bvp_linear_12_function = ODEFunction(prob_bvp_linear_12_f!, analytic=prob_bvp_linear_12_analytic)
prob_bvp_linear_12_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_12
...
"""
prob_bvp_linear_12 = BVProblem(prob_bvp_linear_12_function, prob_bvp_linear_12_bc!, [1., 0.], prob_bvp_linear_12_tspan, λ)
...
prob_bvp_linear_13_function = ODEFunction(prob_bvp_linear_13_f!, analytic=prob_bvp_linear_13_analytic)
prob_bvp_linear_13_tspan = (-1., 1.)
@doc raw"""
    prob_bvp_linear_13
...
"""
prob_bvp_linear_13 = BVProblem(prob_bvp_linear_13_function, prob_bvp_linear_13_bc!, [1., 0.], prob_bvp_linear_13_tspan, λ)
...
prob_bvp_linear_14_function = ODEFunction(prob_bvp_linear_14_f!, analytic=prob_bvp_linear_14_analytic)
...
"""
prob_bvp_linear_14 = BVProblem(prob_bvp_linear_14_function, prob_bvp_linear_14_bc!, [1., 0.], prob_bvp_linear_14_tspan, λ)
...
"""
prob_bvp_linear_15 = BVProblem(prob_bvp_linear_15_function, prob_bvp_linear_15_bc!, [1., 0.], prob_bvp_linear_15_tspan, λ)
...
prob_bvp_linear_16_function = ODEFunction(prob_bvp_linear_16_f!, analytic=prob_bvp_linear_16_analytic)
prob_bvp_linear_16_tspan = (0., 1.)
@doc raw"""
    prob_bvp_linear_16
...
"""
prob_bvp_linear_16 = BVProblem(prob_bvp_linear_16_function, prob_bvp_linear_16_bc!, [1., 0.], prob_bvp_linear_16_tspan, λ)
...
prob_bvp_linear_17_function = ODEFunction(prob_bvp_linear_17_f!, analytic=prob_bvp_linear_17_analytic)
...
"""
prob_bvp_linear_17 = BVProblem(prob_bvp_linear_17_function, prob_bvp_linear_17_bc!, [1., 0.], prob_bvp_linear_17_tspan, λ)
...
prob_bvp_linear_18_function = ODEFunction(prob_bvp_linear_18_f!, analytic=prob_bvp_linear_18_analytic)
...
"""
prob_bvp_linear_18 = BVProblem(prob_bvp_linear_18_function, prob_bvp_linear_18_bc!, [1., 0.], prob_bvp_linear_18_tspan, λ)
