...
"""
const prob_dde_RADAR5_oregonator = let k₁ = 1.34, k₂ = 1.6e9, k₃ = 8_000, k₄ = 4.0e7, f = 1,
    ...
    DDEProblem(
        f_dde_RADAR5_oregonator!, h_dde_RADAR5_oregonator, (0.0, 100.5);
        constant_lags = [τ]
    )
end
...
"""
const prob_dde_RADAR5_robertson = let a = 0.04, b = 10_000, c = 3.0e7, τ = 0.01
    ...
    DDEProblem(
        f_dde_RADAR5_robertson!, h_dde_RADAR5_robertson, (0.0, 1.0e10);
        constant_lags = [τ]
    )
end
...
let α = 1.8, β = 20, γ = 0.002, r = 50_000, s = 100_000
    global function f_dde_RADAR5_waltman!(du, u, h, p, t)
        ...
        if t < t₁
            ...
            du[6] = (1.0e-12 + u[2] + u[3]) / (1.0e-12 + w[2] + w[3])
        end
...
function h_dde_RADAR5_waltman(p, t)
    ...
    return [p.ϕ₀, 1.0e-15, 0.0, 0.0, 0.0, 0.0]
end

const prob_dde_RADAR5_waltman = DDEProblem(
    f_dde_RADAR5_waltman!,
...
Immunology (8), pp. 437-453.
"""
const prob_dde_RADAR5_waltman_2 = remake(
    prob_dde_RADAR5_waltman;
...
Immunology (8), pp. 437-453.
"""
const prob_dde_RADAR5_waltman_3 = remake(
    prob_dde_RADAR5_waltman;
    p = (ϕ₀ = 1.0e-5, t₀ = 33, t₁ = 145)
)
...
Immunology (8), pp. 437-453.
"""
const prob_dde_RADAR5_waltman_4 = remake(
    prob_dde_RADAR5_waltman;
...
Immunology (8), pp. 437-453.
"""
const prob_dde_RADAR5_waltman_5 = remake(
    prob_dde_RADAR5_waltman;
