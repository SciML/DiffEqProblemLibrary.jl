...
"""
const prob_dde_DDETST_C3 =
  let s₀ = 0.0031, T₁ = 6, γ = 0.001, Q = 0.0275, k = 2.8, a = 6570, K = 0.0382, r = 6.96
...
boundary condition and state dependent delay, Private communication.
"""
const prob_dde_DDETST_C4 =
  let s₀ = 0.00372, T₁ = 3, γ = 0.01, Q = 0.00178, k = 6.65, a = 15600, K = 0.0382, r = 6.96
...
"""
const prob_dde_DDETST_D2 =
  let r₁ = 0.02, r₂ = 0.005, α = 3, δ = 0.01
...
"""
const prob_dde_DDETST_E1 =
  let r = π / sqrt(3) + 1 / 20, c = sqrt(3) / (2 * π) - 1 / 25
...
"""
const prob_dde_DDETST_E2 =
  let α = 0.1, ρ = 2.9, τ = 0.42
...
const prob_dde_DDETST_F4 =
  remake(prob_dde_DDETST_F3;
         f = DDEFunction(f_dde_DDETST_F4; analytic = fanalytic_dde_DDETST_F345))
...
const prob_dde_DDETST_F5 =
  remake(prob_dde_DDETST_F3;
         f = DDEFunction(f_dde_DDETST_F5; analytic = fanalytic_dde_DDETST_F345))
...
const prob_dde_DDETST_H3 =
  remake(prob_dde_DDETST_H2;
         f = DDEFunction(f_dde_DDETST_H3; analytic = fanalytic_dde_DDETST_H234))
...
const prob_dde_DDETST_H4 =
  remake(prob_dde_DDETST_H2;
         f = DDEFunction(f_dde_DDETST_H4; analytic = fanalytic_dde_DDETST_H234))
