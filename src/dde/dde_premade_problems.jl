...
for p in (:(1delay), :(1delay_long), :(2delays), :(2delays_long))
    @eval begin
        Base.@deprecate_binding $(Symbol(:prob_dde_, p)) $(Symbol(:prob_dde_constant_, p,
                                                                  :_ip))
        Base.@deprecate_binding $(Symbol(:prob_dde_, p, :_notinplace)) $(Symbol(:prob_dde_constant_,
                                                                                p, :_oop))
        Base.@deprecate_binding $(Symbol(:prob_dde_, p, :_scalar_notinplace)) $(Symbol(:prob_dde_constant_,
                                                                                       p,
                                                                                       :_scalar))

        Base.@deprecate $(Symbol(:build_prob_dde_, p))(u₀, t = u₀) remake_dde_constant_u0_tType($(Symbol(:prob_dde_constant_,
                                                                                                         p,
                                                                                                         :_ip)),
                                                                                                [
                                                                                                    u₀,
                                                                                                ...
                                                                                                typeof(t))
        Base.@deprecate $(Symbol(:build_prob_dde_, p, :_notinplace))(u₀, t = u₀) remake_dde_constant_u0_tType($(Symbol(:prob_dde_constant_,
                                                                                                                       p,
                                                                                                                       :_oop)),
                                                                                                              [
                                                                                                                  u₀,
                                                                                                              ...
                                                                                                              typeof(t))
        Base.@deprecate $(Symbol(:build_prob_dde_, p, :_scalar_notinplace))(u₀, t = u₀) remake_dde_constant_u0_tType($(Symbol(:prob_dde_constant_,
                                                                                                                              p,
                                                                                                                              :_scalar)),
                                                                                                                     u₀,
                                                                                                                     typeof(t))
